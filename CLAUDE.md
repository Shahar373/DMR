...
- **⚠ `scaled_taps` נבדק ונמצא מיותר (v0.16.0):** דחיית הערוץ השכן עם 121
  taps ב-672kHz היא כבר ‎−53 dB בהיסט 21 kHz. ההשערה ש"דליפה מערוץ שכן"
  גרמה לכשלי ה-FEC **הופרכה במדידה** — הסיבה הייתה פאזת הדצימציה. הדגל
  נשאר opt-in; אל תפעילו אותו כברירת-מחדל בלי ראיה חדשה.
