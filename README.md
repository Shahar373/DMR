...
> ⚠️ **מיפוי הערוצים (LCN↔תדר) מתגלה חלקית בלבד:** Cap+ משדר ערוץ *לוגי* (LSN),
> לא תדר, ו-SDR יחיד לא יכול לצפות בערוץ הבקרה ובערוץ הקול בו-זמנית. הגילוי
> חושף את תדר הבקרה ואת ה-CC — את מפת הערוצים המלאה משלימים ידנית במסך הבית.
